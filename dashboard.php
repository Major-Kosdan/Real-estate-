...
<div class="dashboard-container">
    ...
    <div class="dashboard-actions">
        <a href="/real-estate/listings/post_item.php" class="dash-action">📦 Add Property</a>
        <a href="/real-estate/listings/my_listings.php" class="dash-action">📋 My Properties</a>
        <a href="/real-estate/listings/market.php" class="dash-action">🌐View All Properties</a>
        <a href="/real-estate/profile/profile.php" class="dash-action">👤 Admin Account Setting</a>
        <a href="/real-estate/auth/logout.php" class="dash-action logout">🚪 Logout</a>
    </div>
</div>
