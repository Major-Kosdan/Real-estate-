...
<div class="container">
  ...
  <p class="page-subtitle">Browse properties carefully listed by our admin across Enugu.</p>
  Property Marketplace

 
  <div class="market-warning blink">
    👀 <strong>View Safely:</strong> Always meet the admin or follow their instructions when visiting a property. Use safe, well-known locations for viewings.<br><br>
    <span class="do-not-pay">❌  <strong>No Advance Payments:</strong> Always verify the property and details through the admin before making any payment!</span>
  </div>
